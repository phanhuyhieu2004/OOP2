...
//      Lớp bai5.Main: Lớp này chứa phương thức main để thực thi chương trình. Trong phương thức này, ta tạo một đối tượng MyException và ném ngoại lệ này ra bên ngoài. Nếu có ngoại lệ xảy ra, nó được bắt bởi khối catch và thông báo lỗi được in ra màn hình.
//
//     Bước 3:
