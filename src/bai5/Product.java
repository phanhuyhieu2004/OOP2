...
public class Product implements Serializable {
    ...
    public Product(String p001, String s, int i, String dell) {
    }
 ...
 class ProductProcess {
    ...
    class ProductApp {
         public static void main(String[] args) {
             ...
             Product objProduct1 = new Product("P001", "Laptop Dell Inspiron 15", 15000000, "Dell");
             ...
             Product[] products = ProductProcess.readObjectData("data.dat");
